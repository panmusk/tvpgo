namespace tvpgo.Json
{
    ...
    public class Tokenizer
    {
        ...
        public Format defaultFormat => formats.First(x => x.mimeType.Equals("application/x-mpegurl"));
        public static async Task<Tokenizer> Create(string url)
        {
            return await StaticTools.WebDeserializeAsync<Tokenizer>(url);
        }
    }
